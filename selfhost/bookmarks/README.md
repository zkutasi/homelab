# Bookmarks & save-for-later apps

These kind of apps help you to organize bookmarks outside of your browser, and most of them provide a way to extract the websites offline, to preserve it locally.

## Requirements

- Give some ability to better organize my bookmarks in a centralized place, preferably something that is app-agnostic
- Browser extension to add bookmarks directly from the browser (save and load also)
- Import/Export
