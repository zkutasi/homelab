...
- [ExpenseOwl](https://github.com/Tanq16/ExpenseOwl) - Very simple, expense tracker, not a budgeting app. Only graphs monthly expenses by category in a pie chart. Can import from CSV but only its own format.
